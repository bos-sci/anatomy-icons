...
const SvgIconScalesAccentLight = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <linearGradient
        id="icon-scales-accent-light_svg__a"
        x1={0}
        x2={24}
        y1={37.5}
        y2={37.5}
