...
const SvgIconNumberThreeAccentLight = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" {...props}>
    <defs>
      <linearGradient
        id="icon-number-three-accent-light_svg__a"
        x1={0}
        x2={64}
        y1={32}
        y2={32}
    ...
    <path
      fill="url(#icon-number-three-accent-light_svg__a)"
...
export default SvgIconNumberThreeAccentLight;
